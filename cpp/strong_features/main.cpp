...
// TODO trouver la bonne componsante de rvec a prendre
// TODO Conserver seulement les inliers calculés par la pose
// TODO take percent of rotation error (check why percent can be bigger than 100)
using namespace std;
using namespace cv;
...
int main() {
    ...
    test ("/home/gmanfred/devel/datasets/washington_rgbd/rgbd-dataset/cereal_box/cereal_box_1");
