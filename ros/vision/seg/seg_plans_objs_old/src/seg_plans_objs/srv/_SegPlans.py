"""autogenerated by genpy from seg_plans_objs/SegPlansRequest.msg. Do not edit."""
import sys
...
class SegPlansRequest(genpy.Message):
  _md5sum = "6c042850bdcce03549506f85b146e77b"
  _type = "seg_plans_objs/SegPlansRequest"
...
"""
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(SegPlansRequest, self).__init__(*args, **kwds)
...
"""autogenerated by genpy from seg_plans_objs/SegPlansResponse.msg. Do not edit."""
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
import struct
...
class SegPlansResponse(genpy.Message):
  _md5sum = "3231d5cf1e568de703776582fa3afffe"
  _type = "seg_plans_objs/SegPlansResponse"
  _has_header = False #flag to mark the presence of a Header object
  _full_text = """sensor_msgs/PointCloud2[] segmented_plans
...
"""
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(SegPlansResponse, self).__init__(*args, **kwds)
      #message fields cannot be None, assign default values for those that are
      if self.segmented_plans is None:
        self.segmented_plans = []
    else:
      self.segmented_plans = []
  ...
  def serialize(self, buff):
    ...
    """
    try:
      length = len(self.segmented_plans)
      buff.write(_struct_I.pack(length))
      for val1 in self.segmented_plans:
        _v1 = val1.header
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        ...
        self.segmented_plans.append(val1)
      return self
    except struct.error as e:
      raise genpy.DeserializationError(e) #most likely buffer underfill
...
class SegPlans(object):
  _type          = 'seg_plans_objs/SegPlans'
  _md5sum = '73a9f83b02cede52fedb253954bf89a9'
  _request_class  = SegPlansRequest
  _response_class = SegPlansResponse
