...
//public:
    ...
    void get_centre (gdiam_point_t &centre)
    {
      gdiam_point_t  pt_max, pt_min;
      pnt_zero( pt_min );
      pnt_zero( pt_max );      

			// scale and add ?!
      pnt_scale_and_add( pt_min, low_1, dir_1 );
      pnt_scale_and_add( pt_min, low_2, dir_2 );
      pnt_scale_and_add( pt_min, low_3, dir_3 );
			// scale and add ?!            
      pnt_scale_and_add( pt_max, high_1, dir_1 );
      pnt_scale_and_add( pt_max, high_2, dir_2 );
      pnt_scale_and_add( pt_max, high_3, dir_3 );
      
      centre[0] = pt_min[0] + (pt_max[0] - pt_min[0])/2;
      centre[1] = pt_min[1] + (pt_max[1] - pt_min[1])/2;
      centre[2] = pt_min[2] + (pt_max[2] - pt_min[2])/2;
    }
