"""autogenerated by genpy from reco_3d/IterativeClosestPointRecognitionRequest.msg. Do not edit."""
import sys
...
class IterativeClosestPointRecognitionRequest(genpy.Message):
  _md5sum = "a20c1ca225a936faa11b15fe52b8035a"
  _type = "reco_3d/IterativeClosestPointRecognitionRequest"
...
"""
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(IterativeClosestPointRecognitionRequest, self).__init__(*args, **kwds)
...
"""autogenerated by genpy from reco_3d/IterativeClosestPointRecognitionResponse.msg. Do not edit."""
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
import struct
...
class IterativeClosestPointRecognitionResponse(genpy.Message):
  _md5sum = "6c8e24fc2da06fa07a4f04e0960efe80"
  _type = "reco_3d/IterativeClosestPointRecognitionResponse"
  _has_header = False #flag to mark the presence of a Header object
  _full_text = """
int32 SUCCESS=0
int32 ERROR=1
...
"""
  ...
  __slots__ = ['pose','names','distances','result']
  _slot_types = ['geometry_msgs/PoseStamped','string[]','float32[]','int32']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(IterativeClosestPointRecognitionResponse, self).__init__(*args, **kwds)
      #message fields cannot be None, assign default values for those that are
...
class IterativeClosestPointRecognition(object):
  _type          = 'reco_3d/IterativeClosestPointRecognition'
  _md5sum = '9d35d3a39146a55cfd7050bc8e19ba64'
  _request_class  = IterativeClosestPointRecognitionRequest
  _response_class = IterativeClosestPointRecognitionResponse
