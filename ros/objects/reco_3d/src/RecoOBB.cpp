...
std::vector< std::pair<std::string, float> >
	RecoOBB::recognize (float w, float h, float d, float max_distance,
...
void RecoOBB::load_training_file (std::string stats_filepath)
{
...
//	Private methods
////////////////////////////////////////////////////////////////////////////////
vector< pair<string, float> > RecoOBB::recognize (pcl::PointXYZ descriptor, float max_distance,
...
float RecoOBB::mahalanobis_distance (Eigen::Matrix3f cov, Eigen::Vector3f mean, pcl::PointXYZ pt)
{
