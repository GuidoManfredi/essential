...
void test_classification () {
	...
	std::vector<Point> occupied_points = sp.get_occupied_points (walls_img);
	/*
	...
	*/
	...
	Mat labels;
	op.classify(occupied_points, centers, labels);
	cout << centers << endl;
	Mat display2 = draw_points_labels (walls_img.cols, walls_img.rows, occupied_points, labels);
	...
	*/
	...
	cv::imwrite ("./result_classif.png", display2);
